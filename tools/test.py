...
# Modifications: Support for eval on validation set
# Modifications: Support for separate_eval
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument('--separate_eval', action='store_true', help='eval each split separately')
...
def main():
    ...
    if args.val:
        cfg.data.val['separate_eval'] = args.separate_eval
        dataset = build_dataset(cfg.data.val)
    else:
        cfg.data.test['separate_eval'] = args.separate_eval
