...
Cityscapes_palette_16 = Cityscapes_palette[0: 9 * 3] + Cityscapes_palette[10 * 3: 14 * 3] + \
                        Cityscapes_palette[15 * 3: 16 * 3] + Cityscapes_palette[17 * 3:]

Cityscapes_palette_13 = Cityscapes_palette[0: 3 * 3] + Cityscapes_palette[6 * 3: 9 * 3] + \
                        Cityscapes_palette[10 * 3: 14 * 3] + Cityscapes_palette[15 * 3: 16 * 3] + \
                        Cityscapes_palette[17 * 3:]

Cityscapes_palette_7 = [128, 64, 128, 70, 70, 70, 153, 153, 153, 107, 142, 35,
...
def subplotimg(ax,
    ...
    if img is None:
        return
    if nc == 16:
        palette = Cityscapes_palette_16
    elif nc == 13:
        palette = Cityscapes_palette_13
    elif nc == 7:
        palette = Cityscapes_palette_7
    with torch.no_grad():
